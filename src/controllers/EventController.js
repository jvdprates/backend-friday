...
module.exports = {
    ...
    async getAll(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to get events" });
        }
    },
    ...
    async getOne(request, response) {
        try {
            ...
            console.log("Event reading failed: " + err);
            return response.status(500).json({ notification: "Internal server error while trying to get one event" });
        }
    },
    ...
    async update(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to update event" });
        }
    },
    ...
    async delete(request, response){
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to delete Event" });
        }
    }
}