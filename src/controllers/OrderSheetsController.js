...
module.exports = {
    async create(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to create order_sheet" });
        }
    },
    ...
    async index(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to get order_sheets" });
        }
    },
    ...
    async update(request, response) {
        try {
            ...
            const result = await OrderSheetsModel.updateOrderSheets(order_sheet_id, order_sheet);
            return response.status(200).json(result);
        } catch (err) {
            console.log("OrderSheet updating failed: " + err);
            return response.status(500).json({ notification: "Internal server error while trying to update order_sheet" });
        }
    },
    ...
    async delete(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to delete OrderSheet" });
        }
    }
}