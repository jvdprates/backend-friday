...
module.exports = {
    async create(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to create comment" });
        }
    },
    ...
    async delete(request, response) {
        try {
            ...
            return response.status(500).json({ notification: "Internal server error while trying to delete comment" });
        }
    }
}